...
| Sum                          | oeis                     | About                                                                                                                                                      |
|------------------------------+--------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------|
| \( D(n) = \sum\sigma_0(n) \) | https://oeis.org/A006218 | ([[https://en.wikipedia.org/wiki/Divisor_summatory_function][The divisor summatory function]]) Can be done in \( O(\sqrt{n} }) \) (see below) and extended to \( O(n^{\frac{1}{3} }) \): https://arxiv.org/abs/1206.3369 |
